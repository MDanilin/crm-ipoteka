...
function LoginPage() {
    ...
    const setAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$store$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthStore"])((s)=>s.setAuth);
    ...
    async function sendOtp(phone) {
        ...
        setError('');
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post('/auth/send-otp', {
                phone
            });
    ...
    async function handleVerifyOtp(code) {
        ...
        setError('');
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post('/auth/verify-otp', {
                phone: fullPhone,
                code
            });
    ...
    async function handleAgentLogin() {
        ...
        setError('');
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post('/auth/login', {
                login: agentLogin,
                password: agentPass
            });
...
"[project]/apps/web/src/app/login/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=%5Bproject%5D__4ee706._.js.map